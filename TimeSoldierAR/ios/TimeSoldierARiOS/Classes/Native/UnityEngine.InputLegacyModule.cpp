...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C * Input_get_compass_mC1A2BFFE95633B2AC73FA82B12A538340EBC08F5 (const RuntimeMethod* method)
{
	...
	bool V_0 = false;
	Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C * V_1 = NULL;
	{
		...
		V_0 = (bool)((((RuntimeObject*)(Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C *)L_0) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_1 = V_0;
		if (!L_1)
		{
			goto IL_0017;
	...
	{
		Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C * L_2 = (Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C *)il2cpp_codegen_object_new(Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C_il2cpp_TypeInfo_var);
		Compass__ctor_m2D4421400B58D5C771960D125408E210C28026EE(L_2, /*hidden argument*/NULL);
		((Input_tCCB96DE9636DD2C1993637958AA227434290E523_StaticFields*)il2cpp_codegen_static_fields_for(Input_tCCB96DE9636DD2C1993637958AA227434290E523_il2cpp_TypeInfo_var))->set_compassInstance_1(L_2);
	}

IL_0017:
	{
		Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C * L_3 = ((Input_tCCB96DE9636DD2C1993637958AA227434290E523_StaticFields*)il2cpp_codegen_static_fields_for(Input_tCCB96DE9636DD2C1993637958AA227434290E523_il2cpp_TypeInfo_var))->get_compassInstance_1();
		V_1 = L_3;
		goto IL_001f;
	}
...
IL_001f:
	{
		Compass_t05C9B25D9A6B7D068A9B25F3985AD927B866B54C * L_4 = V_1;
		return L_4;
	}
}
